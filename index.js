...
const {keyboard, mouse, down} = require('@nut-tree/nut-js');
    ...
    async function SelectNumber(){
        ...
        for(var i = 1; i < 37; i = i + 3){
            ...
            if(columnOne == 8 || columnOne == 5 || columnOne > 8 ){
                let message = `💎Foram repetidos ${columnOne} vezes à primeira coluna !! 💎`;
        ...
        for(var i = 2; i < 37; i = i + 3){
            ...
            if(columnTwo == 8 || columnTwo == 5 || columnTwo > 8){
                let message = `💎Foram repetidos ${columnTwo} vezes à segunda coluna !! 💎`
                bot.telegram.sendMessage(1624289481, message);
                bot.telegram.sendMessage(1443534137, message);
                bot.telegram.sendMessage(5088599673, message);
                console.log('Mensagem enviada');
        ...
        for(var i = 3; i < 37; i = i + 3){
            ...
            if(columnThree == 8 || columnThree == 5 || columnThree > 8){
                let message = `💎Foram repetidos ${columnThree} vezes à terceira coluna !! 💎`;
                bot.telegram.sendMessage(1624289481, message);
                bot.telegram.sendMessage(1443534137, message);
                bot.telegram.sendMessage(5088599673, message);
                console.log('Mensagem enviada');
        ...
        for(var i = 1; i <= 12; i++){
            ...
            if(duzia1 >= 8 || duzia1 == 5){
                let message = `🎈 Foram sorteados ${duzia1} vezes à primeria duzia !!! 🎈`;
                bot.telegram.sendMessage(1624289481, message);
                bot.telegram.sendMessage(1443534137, message);
                bot.telegram.sendMessage(5088599673, message);
        ...
        for(var i = 13; i <= 24; i++){
            ...
            if(duzia2 >= 8 || duzia2 == 5){
                let message = `🎈 Foram sorteados ${duzia2} vezes à segunda duzia !!! 🎈`;
                bot.telegram.sendMessage(1624289481, message);
                bot.telegram.sendMessage(1443534137, message);
                bot.telegram.sendMessage(5088599673, message);
        ...
        for(var i = 25; i <= 36; i++){
            ...
            if(duzia3 >= 8 || duzia3 == 5){
                let message = `🎈 Foram sorteados ${duzia3} vezes à terceira duzia !!! 🎈`;
                bot.telegram.sendMessage(1624289481, message);
                bot.telegram.sendMessage(1443534137, message);
                bot.telegram.sendMessage(5088599673, message);
...
// var nome = [1,2,3,14,44];

// console.log(`Sequencia de numeros sorteados na primera duzia : ${nome.toString()}..\n\nTotal de numeros sorteados ${nome.length}`);